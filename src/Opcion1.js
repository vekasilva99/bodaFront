...
function App() {
  return (
    ...
    <div className="papas-container">
      <div className="papas"><h3>Juan Carlos Antillano Monagas</h3><h3>Ysabel Vetancourt De Antillano</h3></div>
      <div className="papas"><h3>Vicente Rosa Muñoz</h3><h3>Andreina Uzcátegui De Rosa</h3></div>
    </div>
    <div className="invitar"><h3>Se complacen en invitarles al matrimonio de sus hijos</h3></div>
    <div className="novios"><h1>Isabella y Vicente Emilio</h1></div>
    <div className="invitar sin-margen"><h3>Ceremonia que se efectuará el sábado dos de julio de dos mil veintidós</h3>
    <h3>a las cuatro de la tarde en los jardines de la casa Samambaya, Caracas</h3></div>
    <div className="papas-container con-margen">
      <div className="papas"><h4>Recepción: Casa Samambaya</h4><h4>Los Guayabitos, Caracas</h4></div>
      <div className="papas"><h4>Cinco y treinta de la tarde</h4><h4>Traje Formal</h4></div>
    </div>
    </div>
     </div>
